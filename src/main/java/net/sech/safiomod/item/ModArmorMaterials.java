...
public enum ModArmorMaterials implements ArmorMaterial {
    AMETHYST_SHARD("amethyst_shard", 26, new int[]{ 0, 0, 5, 0 }, 25,
            ModSounds.EQUIP_BUTT_PLUG.get(), 1F, 0F, () -> Ingredient.of(Items.AMETHYST_SHARD));
    ...
    public String getName() {
        return SafioMod.MOD_ID +  ":" + this.name;
    }
