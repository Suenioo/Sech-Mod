...
import net.sech.safiomod.item.ModArmorMaterials;
...
public class ButtPlug extends ArmorItem {
    ...
    public void onArmorTick(ItemStack stack, Level world, Player player) {
        if (!world.isClientSide()) {
            // Verifica si este ítem es el pantalón y si tiene el material correcto
            if (this.getType() == Type.LEGGINGS && this.getMaterial() == ModArmorMaterials.AMETHYST_SHARD) {
                MobEffectInstance effect = MATERIAL_TO_EFFECT_MAP.get(ModArmorMaterials.AMETHYST_SHARD);
